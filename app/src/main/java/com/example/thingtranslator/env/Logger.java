...
public final class Logger {
  ...
  static {
    ...
    IGNORED_CLASS_NAMES.add(com.example.thingtranslator.env.Logger.class.getCanonicalName());
  }
  ...
  private static String getCallerSimpleName() {
    ...
    return com.example.thingtranslator.env.Logger.class.getSimpleName();
  }
